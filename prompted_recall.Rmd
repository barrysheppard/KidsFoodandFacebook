...
# To start over with Andy Fields version

# Product 
Product <- prompted_recall$Product[prompted_recall$Product!="NonFood"]
Recall <- prompted_recall$Recall[prompted_recall$Product!="NonFood"]
CrossTable(Product, Recall, fisher = TRUE, chisq = TRUE, expected = TRUE, sresid = TRUE, format = "SPSS", digits = 2)
...
# Lets plot it
mosaic(prompted_recall_table, shade=TRUE, main = "Participant's recall of product adverts", pop=FALSE, legend=FALSE)
